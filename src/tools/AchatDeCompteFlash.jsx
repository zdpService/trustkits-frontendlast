...
// ✅ Mapping devise : symbole → code ISO + symbole
const CURRENCY_MAP = {
  "€": { code: "EUR", symbol: "€" },
  "$": { code: "USD", symbol: "$" },
  "£": { code: "GBP", symbol: "£" },
...
const CompteFlashPro = () => {
  ...
  const [clientData, setClientData] = useState({
    ...
    soldeInitial: "0,00",
    devise: "€", // ✅ On garde le symbole dans le formulaire
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ On stocke le SYMBOLE dans Firebase (pour App2)
      const clientProfileData = {
        ...
        pinAccess: pin,
        solde: 0,
        devise: clientData.devise, // ✅ Symbole : €, $, £, ₦
        iban: iban,
